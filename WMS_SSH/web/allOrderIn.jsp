...
alert('<%=request.getAttribute("msg") + ""%>');
		...
		%>
		<form action="" name="myfrom">
		<table border="0" width="100%" align="center">
			<tr bgcolor="#ff9966">
				<td>
					当前位置：基础信息管理〉入库订单管理〉〉
				</td>
				<td><a href ="findPayedOrderIn?value=pay">已付款订单</a></td>
				<td><a href ="findPayedOrderIn?value=nopay">未付款订单</a></td>
				<td>
					<a href="xmlForOrderLineIn?style=in">输出</a>
				</td>
			</tr>
		...
		<form action="" name="myForm">
			...
			<table width="70%" align="center">
   			...
   			<tr>
   				<td colspan="3"><a href="PayAllMoney?id=${OId} &value=in">已完成付款</a></td>
   			</tr>
   		</table>
   		<tr><td><br/></td></tr>
				</s:iterator>
