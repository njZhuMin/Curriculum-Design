...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="94%" valign="bottom"><span class="STYLE1"> 商品入库信息  </span></td>
              </tr>
            </table></td>
  ...
  <tr>
    <td>
    <form action="addOrder?style=add" name="myform" method="post" onsubmit="return doSubmit()">
    <input type="hidden" name="order.product.PId" value="${id}"/>
    <input type="hidden" id ="goodid" name="sto.product.PId" value="${id}"/>
     <input type="hidden" name="order.OStyle" value="1"/>
   	<table border="0" width="80%" align="center" bgcolor="#ffeeff" cellspacing="4" >
		...
		<tr align="ce">
			<td colspan="2">
				&nbsp;&nbsp;&nbsp;&nbsp;<select  name="id" onchange="f1('selectProToSto?a=add')" >
					<%if(request.getAttribute("type").equals("1")){
					 %>
					<option>请选择入库商品的商品名称</option>
		...
		<tr align="left">
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;数量：	</td>
			<td><input type="text" id="num" onblur="count()" name="order.ONum"/>
			<font color="red">*</font></td>
			<td>单价：	</td>
			<td>
			<input type="hidden" id="PSingleMoney" value="${pro.PSingleMoney}"/>
			 ${pro.PSingleMoney}</td>
			
		</tr>
		<tr align="left">
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;总价：	</td>
			<td><input type="text" id="OAllMoney" onblur="count()"  name="order.OAllMoney" />（元）<font color="red">*</font></td>
			<td>实付：	</td>
			<td><input type="text" onblur="cut()" id="OPayMoney" name="order.OPayMoney"/></td>
		</tr>
		<tr align="left">
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;未付：	</td>
			<td><input type="text" id="nopay" />（元）<font color="red">*</font></td>
			<td>操作员：	</td>
			<td><input type="text" value="${username}" disabled="disabled" />
				<input type="hidden"   name="order.OAdminerId" value="${username}" />
				<input type="hidden"   name="sto.SAdminer" value="${username}" />
				</td>
		</tr>
		<tr align="left">
			<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;入库日期：	</td>
